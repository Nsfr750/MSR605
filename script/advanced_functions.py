...
from PyQt6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QTabWidget, QCheckBox, QPushButton,
    QTextEdit, QLabel, QLineEdit, QRadioButton, QButtonGroup, QMessageBox,
    QGroupBox, QSizePolicy, QApplication, QFrame, QScrollArea
)
...
class AdvancedFunctionsWidget(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None, tracks: Optional[List[str]] = None):
    ...
    def setup_decode_tab(self):
        ...
        # Results area
        decode_layout.addWidget(QLabel("<b>Decoded Data:</b>"))
    ...
    def setup_decrypt_tab(self):
        ...
        self.data_text.setPlaceholderText("Enter data to decrypt or use 'Load Track Data'...")
    ...
    def decode_selected_tracks(self):
        ...
        if results:
            ...
            self.decode_text.setPlainText("No valid track data found in selected tracks.")
    ...
    def decrypt_data(self):
        ...
        if not key or not data:
            QMessageBox.critical(
                self, 
                "Error", 
                "Both key and data are required"
            )
            return
