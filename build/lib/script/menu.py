...
class MenuBar(QMenuBar):
    ...
    def init_menus(self):
        ...
        self.auto_save_action.setChecked(getattr(self.parent, '_GUI__auto_save_database', False))
        ...
        self.duplicates_action.setChecked(getattr(self.parent, '_GUI__enable_duplicates', False))
    ...
    def retranslate_ui(self):
        ...
        # Database submenu
        database_menu = self.file_menu.addMenu(tr('menu_database', self.language_manager))
        
        # View Database action
        view_db_action = QAction(tr('menu_view_database', self.language_manager), self.parent)
        view_db_action.triggered.connect(self.parent.view_database)
        database_menu.addAction(view_db_action)
        
        # Export to CSV action
        export_csv_action = QAction(tr('menu_export_csv', self.language_manager), self.parent)
        ...
        # Language submenu
        language_menu = self.tools_menu.addMenu(tr('menu_language', self.language_manager))
        ...
        if not hasattr(self, 'help_action'):
            ...
            self.help_action.triggered.connect(lambda: show_help(self.parent, self.language_manager))
